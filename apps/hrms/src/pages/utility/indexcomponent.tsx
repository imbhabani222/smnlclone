...
import { Utility_Sub_Menu } from './route';
...
const View = (props: Props) => {
  ...
  const compt = () => {
    const comp: any = Utility_Sub_Menu.find(
  ...
  return (
    <>
      <HeaderNavigation menus={Utility_Sub_Menu} />
      <Panel>
        {/* <Filter /> */}
        ...
        {/* <div>
          ...
          {/* <Filter /> */}
        <div style={{ margin: '15px 20px 15px 20px', height: '100%' }}>
          {compt()}
        </div>
        {/*} </div> */}
      </Panel>
