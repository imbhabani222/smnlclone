...
import { Product_Configuration_Sub_Menu } from './route';
...
const View = (props: Props) => {
  ...
  const compt = () => {
    const comp: any = Product_Configuration_Sub_Menu?.find(
  ...
  return (
    <div>
      <HeaderNavigation menus={Product_Configuration_Sub_Menu} />
      <Panel>
        {/* <div>
