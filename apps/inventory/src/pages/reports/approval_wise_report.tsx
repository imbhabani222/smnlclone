...
const View = (props: any) => {
  ...
  const pageData = {
    pageTitle: 'Approval Wise Report',
  ...
  useEffect(() => {
    ...
    getSectionWiseReport(
      ...
      modifiedData.forEach((item:any) => item.section = item.section.value)
  ...
  const onDownloadExcel = () => {
    ...
    handleExportInventory(data, 'Approval Reports','Approval Report');
  };
  const onDownloadPdf = () => {
    ...
    rep.html(document.querySelector('#payslip_id'), {
      callback: function (pdf: any) {
        ...
        rep.setFontSize(28);
        rep.text('Approval Wise Report', rep.internal.pageSize.width / 2, 145, {
          align: 'center',
        });
        autoTable(rep, {
          theme: 'grid',
        ...
        pdf.save('ApprovalWiseReport.pdf');
      },
    });
  };
