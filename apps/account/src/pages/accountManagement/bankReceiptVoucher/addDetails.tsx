...
const Create = (props: any) => {
  ...
  useEffect(() => {
    if (mainId) {
      // setloading(true)
      getFields('Bank Receipt Voucher Details', 'htssuite').then((_items) => {
        setformData(_items);
        //     const {
        ...
        getDocTypes('Bank Receipt Voucher Details', false, 'htssuite').then(
  ...
  return (
    <>
      ...
      <FormTable
        ...
        doctype="Bank Receipt Voucher Details"
        doc_id={mainId}
