...
//   }
  ...
  const onDownloadExcel = ()=>{
    ...
    handleExportAccounts(AddFooterToExcel(data,totalObject), "Credit Note Register Reports","Credit Note Register Report")
  }
  ...
  const onDownloadPdf = ()=>{
    ...
    rep.html(document.querySelector('#payslip_id'),{
      callback: function (pdf:any){
        ...
        rep.setFontSize(28);
        rep.text('Credit Note Register',250,145);
        autoTable(rep, {
          theme : 'grid',
          head : [columnd],
          body : mapedData,
        ...
        pdf.save("CreditNoteRegister.pdf")
      }
    })
  }
