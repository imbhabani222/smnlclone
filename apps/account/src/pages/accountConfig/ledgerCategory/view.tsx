...
const View = (props: Props) => {
  ...
  useEffect(() => {
    getDocTypes('Inventory Ledger Category',false,'htssuite').then((items) => {
      setcolumns(items);
    });
  ...
  return (
    <>
      ...
      <Table column={columns} dataSource={data} editUrl="/edit-ledger-category" 
